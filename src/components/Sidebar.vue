...
const loadingListas = ref(false);
 ...
 onMounted(() => {
  ...
  function getTodos() {
    ...
    return axios.get('https://BackEnd.randallcs15.repl.co/api/groups').then(      response => {
  ...
  function getListas() {
    ...
    return axios.get('https://BackEnd.randallcs15.repl.co/api/checklists').then(      response => {
...
axios.put(`https://BackEnd.randallcs15.repl.co/api/groups/update/${id}` , {name}).then( response => {
...
axios.delete(`https://BackEnd.randallcs15.repl.co/api/lists/destroy/${id}` , {name}).then( response => {
